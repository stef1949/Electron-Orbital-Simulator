...
export function makeWebGPU(): any {
  return {
    initialized: false,
    device: null,
    context: null,
...
export async function initWebGPU(webgpu: any, container: HTMLElement): Promise<boolean> {
...
export function ensureWebGPUParticles(webgpu: any, n: number, l: number, m: number, numPoints: number): void {
...
export function renderWebGPUFrame(webgpu: any, camera: any, adaptiveFrame: number): void {
  if (!webgpu.initialized) return;
